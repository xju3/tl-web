...
export default [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        name: 'add',
        path: '/device/product/:id/item/add',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/tenant/material',
        name: 'tenant.material',
        icon: 'smile',
        component: './Tenant/material/List',
      },
      {
        path: '/tenant/material/edit',
        name: 'tenant.material.edit',
        component: './Tenant/material/Edit',
        hideInMenu: true,
      },
      {
        path: '/tenant/material/edit/:id',
        name: 'tenant.material.edit',
        component: './Tenant/material/Edit',
        hideInMenu: true,
      },
      {
        path: '/tenant/material/view/:id',
        name: 'tenant.material.view',
        component: './Tenant/material/View',
        hideInMenu: true,
      },
    ],
  },
